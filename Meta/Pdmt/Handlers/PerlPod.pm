...
package Meta::Pdmt::Handlers::PerlPod;
...
sub add_node($$$) {
	...
	if(Meta::Lang::Perl::Perl::is_perl($path)) {
		my($new_file)="manx/".Meta::Utils::Utils::remove_suffix($path).".man";
		my($new_node)=Meta::Pdmt::Nodes::PerlPod->new();
...
Meta::Pdmt::Handlers::PerlPod - what does your module/class do.
...
=head1 SYNOPSIS
	...
	my($object)=Meta::Pdmt::Handlers::PerlPod->new();
...
This is a constructor for the Meta::Pdmt::Handlers::PerlPod object.
...
This is a testing suite for the Meta::Pdmt::Handlers::PerlPod module.
...
Meta::Lang::Perl::Perl(3), Meta::Pdmt::Handler(3), Meta::Pdmt::Nodes::PerlPod(3), strict(3)
