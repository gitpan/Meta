...
base_aegi_conf_nf.pl - add new files to the baseline.
...
=head1 DETAILS
	...
	MANIFEST: base_aegi_conf_nf.pl
	PROJECT: meta
	VERSION: 0.26

=head1 SYNOPSIS

	base_aegi_conf_nf.pl
...
=head1 HISTORY
	...
	0.08 MV make java compilation real
	0.09 MV Java compilation
	0.10 MV perl quality change
