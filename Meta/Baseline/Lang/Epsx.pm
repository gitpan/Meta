...
package Meta::Baseline::Lang::Epsx;
...
Meta::Baseline::Lang::Epsx - language for XML files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Epsx::env();

=head1 DESCRIPTION

This package contains stuff specific to Epsx in the baseline:
