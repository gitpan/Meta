...
package Meta::Baseline::Lang::Manx;
...
Meta::Baseline::Lang::Manx - language for manual page files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Manx::env();

=head1 DESCRIPTION

This package contains stuff specific to Man in the baseline:
Its mainly here to authorize entries of manual page files to the baseline.
