...
package Meta::Baseline::Lang::Clas;
...
Meta::Baseline::Lang::Clas - language for Java class files.
...
=head1 SYNOPSIS
	...
	my($resu)=Meta::Baseline::Lang::Clas::env();

=head1 DESCRIPTION

This package contains stuff specific to Clas in the baseline:
Its mainly here to authorize entries of Java ByteCode files to the baseline.
