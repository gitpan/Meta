...
base_aegi_conf_development_test_command.pl - run tests for aegis in development.
...
=head1 DETAILS
	...
	MANIFEST: base_aegi_conf_development_test_command.pl
	PROJECT: meta
	VERSION: 0.25

=head1 SYNOPSIS

	base_aegi_conf_development_test_command.pl
