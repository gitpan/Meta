...
#$pdmt->get_handlers()->insert(Meta::Pdmt::Handler::Aegis->new());
#$pdmt->get_handlers()->insert(Meta::Pdmt::Handler::Dirx->new());
...
pdmt_test.pl - run a test on Pdmt.
...
=head1 SYNOPSIS
	...
	pdmt_test.pl [options]

=head1 DESCRIPTION

This binary loads a Pdmt object and runs it.
...
Meta::Pdmt::Pdmt(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
