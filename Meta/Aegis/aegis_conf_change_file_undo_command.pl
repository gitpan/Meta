...
aegis_conf_change_file_undo_command.pl - handle Aegis change_file_undo_command notification.
...
=head1 DETAILS
	...
	MANIFEST: aegis_conf_change_file_undo_command.pl
	PROJECT: meta
	VERSION: 0.00

=head1 SYNOPSIS

	aegis_conf_change_file_undo_command.pl
