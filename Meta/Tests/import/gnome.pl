...
gnome.pl - test the external Gnome module.
...
This is a test suite for the Gnome.pm package.
...
Gnome(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
