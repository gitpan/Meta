...
Meta::Utils::Output::print($dump->pl2xml($obje));
...
dumper.pl - test the XML::Dumper module.
...
This is a test suite for the XML::Dumper package.
...
Meta::Baseline::Test(3), Meta::Ds::Hash(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), XML::Dumper(3), strict(3)
