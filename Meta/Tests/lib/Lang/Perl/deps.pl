...
deps.pl - testing program for the Meta:::Lang::Perl::Deps.pm module.
...
This script tests the Meta::Lang::Perl::Deps module.
...
Meta::Baseline::Test(3), Meta::Lang::Perl::Deps(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
