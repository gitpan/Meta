...
rsh.pl - testing program for the Meta::Baseline::Rsh.pm module.
...
This script tests the Meta::Baseline::Rsh module.
...
Meta::Baseline::Rsh(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), strict(3)
