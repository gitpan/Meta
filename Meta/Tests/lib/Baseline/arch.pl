...
$arch->print(Meta::Utils::Output::get_file());
...
arch.pl - testing program for the Meta::Baseline::Arch.pm module.
...
This script tests the Meta::Baseline::Arch module.
...
Meta::Baseline::Arch(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)

=head1 TODO

-add an option to pick a host by random from the hosts file or something
