...
my($module)="perl/lib/Meta/Utils/Utils.pm";
...
fhist.pl - testing program for the Meta::Tool::Fhist.pm module.
...
This is a test suite for the Meta::Tool::Fhist.pm package.
...
Meta::Baseline::Test(3), Meta::Tool::Fhist(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
