...
my($result);
my($xml)=Meta::Xml::ValidWriter->new_string(\$result,"dtdx/impo/xml/docbookx.dtd","email","-//OASIS//DTD DocBook XML V4.1.2//EN");
...
validwriter.pl - testing program for the Meta::Xml::ValidWriter.pm module.
...
This will test the Meta::Xml::ValidWriter.pm module.
...
Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), Meta::Xml::ValidWriter(3), strict(3)
