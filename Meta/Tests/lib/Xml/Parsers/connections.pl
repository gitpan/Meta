...
connections.pl - testing program for the Meta::Xml::Parsers::Connections.pm module.
...
This will test the Meta::Xml::Parsers::Connections.pm module.
Currently it will just read the connection file and print out the
resulting Connections object.
...
Meta::Baseline::Aegis(3), Meta::Baseline::Test(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), Meta::Xml::Parsers::Connections(3), strict(3)
