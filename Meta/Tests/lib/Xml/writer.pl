...
writer.pl - testing program for the Meta::Xml::Writer.pm module.
...
This will test the Meta::Xml::Writer.pm module.
...
Meta::Baseline::Test(3), Meta::Lang::Docb::Params(3), Meta::Utils::Opts::Opts(3), Meta::Utils::System(3), Meta::Xml::Writer(3), strict(3)
