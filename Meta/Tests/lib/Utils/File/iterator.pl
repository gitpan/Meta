...
iterator.pl - testing program for the Meta::Utils::File::Iterator.pm module.
...
This is a test suite for the Meta::Utils::File::Iterator.pm package.
...
Meta::Baseline::Aegis(3), Meta::Baseline::Test(3), Meta::Utils::File::Iterator(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
