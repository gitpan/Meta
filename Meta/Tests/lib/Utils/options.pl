...
$opti->insert("mark","veltzer");
Meta::Utils::Output::print($opti->get("mark")."\n");
...
options.pl - testing program for the Meta::Utils::Options.pm module.
...
This is a test suite for the Meta::Utils::Options.pm package.
The test currently creates an object, puts some options in it and prints
the values of those options back out.
...
=head1 HISTORY
	...
	0.03 MV make options a lot better
...
Meta::Baseline::Test(3), Meta::Utils::Options(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
