...
$grap->node_insert($string_mark);
$grap->node_insert($string_doro);
$grap->edge_insert($string_mark,$string_doro);
...
graph.pl - testing program for the Meta::Ds::Graph.pm module.
...
This is a small test suite for the Meta::Ds::Graph module.
...
Meta::Baseline::Test(3), Meta::Ds::Graph(3), Meta::Ds::String(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
