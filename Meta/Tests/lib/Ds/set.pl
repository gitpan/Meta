...
set.pl - testing program for the Meta::Ds::Set.pm module.
...
This is a testing program for the Meta::Ds::Set.pm module.
currently it just constructs a Set object and prints it out.
...
Meta::Baseline::Test(3), Meta::Ds::Set(3), Meta::Utils::Opts::Opts(3), Meta::Utils::Output(3), Meta::Utils::System(3), strict(3)
